...
var snowStorm = function(window, document) {
  ...
  this.flakesMax = 188;           // Limit total amount of snow made (falling + sticking)
  this.flakesMaxActive = 124;      // Limit amount of snow falling at once (less = lower CPU use)
  ...
  this.snowColor = '#0011ff';     // Don't eat (or use?) yellow snow.
  this.snowCharacter = '&lowast;';// &bull; = bullet, &middot; is square on some systems etc.
  ...
  this.flakeWidth = 14;            // Max pixel width reserved for snow element
  this.flakeHeight = 14;           // Max pixel height reserved for snow element
